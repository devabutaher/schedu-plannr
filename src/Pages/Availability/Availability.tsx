        ...
        <div className='py-8'>
            ...
            <form onSubmit={handleSubmit(handleInfo)}>
                ...
                <input {...register("title")}
                    type="text" className='mt-2 mb-7 border border-primary w-full py-3 px-2 placeholder:text-xl text-xl focus:outline-primary rounded-xl' placeholder='Give your schedule a name' />
                        ...
                        <div className='flex items-center justify-center gap-4 w-[26rem]'>
                            {
                                ...
                                ) : <input {...register("sunEndd")} type="text" defaultValue="unavailable" className='text-3xl focus:outline-none' readOnly />
                        ...
                        <div className='flex items-center justify-center gap-4 w-[26rem]'>
                            {
                                ...
                                ) : <input {...register("monEndd")} type="text" defaultValue="unavailable" className='text-3xl focus:outline-none' readOnly />
                        ...
                        <div className='flex items-center justify-center gap-4 w-[26rem]'>
                            {
                                ...
                                ) : <input {...register("tueEndd")} type="text" defaultValue="unavailable" className='text-3xl focus:outline-none' readOnly />
                        ...
                        <div className='flex items-center justify-center gap-4 w-[26rem]'>
                            {
                                ...
                                ) : <input {...register("wedEndd")} type="text" defaultValue="unavailable" className='text-3xl focus:outline-none' readOnly />
                        ...
                        <div className='flex items-center justify-center gap-4 w-[26rem]'>
                            {
                                ...
                                ) : <input {...register("thuEndd")} type="text" defaultValue="unavailable" className='text-3xl focus:outline-none' readOnly />
                        ...
                        <div className='flex items-center justify-center gap-4 w-[26rem]'>
                            {
                                ...
                                ) : <input {...register("friEndd")} type="text" defaultValue="unavailable" className='text-3xl focus:outline-none' readOnly />
                        ...
                        <div className='flex items-center justify-center gap-4 w-[26rem]'>
                            {
                                ...
                                ) : <input {...register("satEndd")} type="text" defaultValue="unavailable" className='text-3xl focus:outline-none' readOnly />
                ...
                <div className="flex justify-center py-4 mt-5">
                    <button type='submit' className="btn text-white px-10 text-lg">Submit Save</button>
                </div>
            </form>
        </div>
    );
